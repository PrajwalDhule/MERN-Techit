...
const PostSkeleton = () => {
  return (
    ...
    >
      ...
      <div className="h-4 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4 ml-12"></div>
      ...
      <div className="flex items-center justify-center h-80 mb-4 ml-12 bg-gray-300 rounded-sm dark:bg-gray-700">
        <svg
